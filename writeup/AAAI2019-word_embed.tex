...
\begin{equation}
	\begin{split}
		...
		(\nabla f)_i\\    
		0 
		\end{bmatrix}X\Lambda\rangle\\
		=&\Tr\langle (\nabla^T f)_i(\nabla f)_i X\Lambda\rangle\\
		=&\Tr\langle (\nabla^T f)_i(\nabla f)_i UU^T\rangle-\Tr\langle (\nabla^T f)_i(\nabla f)_i UU^TQ_UQ^T_U(\nabla f)^i\rangle\\
		=&\Tr\langle (\nabla f)^i(\nabla f)^i UU^T\rangle-\Tr\langle (\nabla f)^i(\nabla f)^i UU^TQ_UQ^T_U(\nabla f)^i\rangle\\
		\ge& (1-\frac{\eta}{2}\|Q_UQ_U^T\|_2)\|\nabla f U\|_f^2
	\end{split}
\end{equation}
